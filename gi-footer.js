...
$('[datepicker]').each(function () {
      ...
      var default_orientation = 'auto';// top auto, bottom auto, auto left, top left, bottom left, auto right, top right, bottom right
      var default_endDate = "";
      var default_startDate = "";
      
      var format          = $(this).attr("datepicker");
      var orientation = $(this).attr("orientation");
      var startDate  = $(this).attr("start-date");
      var endDate    = $(this).attr("end-date");
 
      orientation = orientation ? orientation : default_orientation;
      format         = format ? format : default_format;
      startDate      = startDate ? startDate : default_startDate;
      endDate   = endDate ? endDate : default_endDate;
      
      $(this).datepicker({format:format,orientation:orientation,startDate:startDate,endDate:endDate});         
 ...
 function checkMobile(phone)
 {
 	...
 	if(mobile.match(/^\d+$/) && mobile.length==10){
 		return true;
 	}
 	else{
 		return false;
