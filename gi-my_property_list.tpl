...
<div class="tab-content">
	<div class="tab-pane active" id="propertylist">
		<div class="col-md-12">
			<div class="clearfix mb-xl"><button class="btn btn-default" data-toggle="modal" data-target="#add_property"><span class="glyphicon glyphicon-plus-sign"></span> Add Property</button></div>
			{if count($property)<1}
