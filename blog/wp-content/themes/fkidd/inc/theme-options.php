...
function fkidd_get_option_defaults() {
	...
	$defaults = array(
		...
		'slider_slide1_content' => __( '<h2>Build your homes</h2><p>We help to you to build your dream home. We use best engineering practices and techniques for building.</p>', 'fkidd' ),
		'slider_slide1_image'	=> get_stylesheet_directory_uri().'/images/slider/1.jpg',
		'slider_slide2_content' => __( '<h2>Sell your real estate assets at highest price</h2><p>We help you in getting maximum selling price of your real estate assets. We will buy or help you to sell your assets.</p><a class="btn" title="Read more" href="#">Read more</a>', 'fkidd' ),
		'slider_slide2_image'	=> get_stylesheet_directory_uri().'/images/slider/2.jpg',		
		'slider_slide3_content' => __( '<h2>Buy homes</h2><p>Buy homes, shops, office spaces or plots as per your needs at minimum possible price as compared to the market.</p><a class="btn" title="Read more" href="#">Read more</a>', 'fkidd' ),
